...
exports.Splitter = React.forwardRef(function (_a, ref) {
    ...
    (0, react_1.useImperativeHandle)(ref, function () {
        return {
            ...
            resetState: function () {
                setState(function (prev) { return (__assign(__assign({}, prev), { handleBarOffsetFromParent: 0, isDragging: false, lastX: 0, lastY: 0, maxMousePosition: undefined, primaryPane: 0 })); });
            }
        };
    ...
    var getHandleMouseMove = (0, react_1.useCallback)(function (state, position, primaryPaneMinHeight, primaryPaneMinWidth, postPoned) {
        return function (e) {
            ...
            ********************************/
            ...
            var handleBarOffsetFromParent = state.handleBarOffsetFromParent, maxMousePosition = state.maxMousePosition;
            var clientX = 0;
            var clientY = 0;
            if (e.type === 'mousemove') {
                clientX = e.clientX;
