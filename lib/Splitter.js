...
var Splitter = function (_a) {
    ...
    var getSize = (0, react_1.useCallback)(function (event, cX, cY) {
        ...
        * This function calculates the max position of a mouse in the current splitter from given percentage.
        ...
        setState(function (prev) { return (__assign(__assign({}, prev), { maxMousePosition: maxMousePosition })); });
    ...
    var handleMouseDown = (0, react_1.useCallback)(function (e) {
        ...
        ********************************/
        ...
        setState(function (prev) { return (__assign(__assign({}, prev), { isDragging: true, handleBarOffsetFromParent: handleBarOffsetFromParent })); });
